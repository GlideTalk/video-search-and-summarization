...
VLM_MODEL_TO_USE="${VLM_MODEL_TO_USE:-openai-compat}" # options: openai-compat, gemini-compat, claude-compat
...
start_via_server() {
    ...
    if [ "$VLM_MODEL_TO_USE" = "openai-compat" ] || [ "$VLM_MODEL_TO_USE" = "gemini-compat" ] || [ "$VLM_MODEL_TO_USE" = "claude-compat" ]; then
